...
class Social2blog_Facebook {
	...
	public function capturePageAdmin() {
		$graph_url_pages = "https://graph.facebook.com/v2.12/me/accounts?access_token=" . $this->access_token;
	...
	public function  getPageToken($id_page){
		...
		$graph_url_pages = "https://graph.facebook.com/v2.12/$id_page?fields=access_token&access_token=" . $this->access_token;
